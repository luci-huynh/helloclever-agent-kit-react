...
3. **Distribution (later)**: private npm package with a CLI: `init` / `sync` / `profile`. **`postinstall` never invokes AI.**
...
6. CLI and private registry.

## Open questions

- Is a public repo acceptable under company policy?
- Should the repo move to a GitHub organization?
- Which AI tools does the team actually use?
